...
describe('StartJamSessionCommand', () => {
  describe('constructor', () => {
    it('should create command with sessionId and initiatorPeerId', () => {
      ...
      expect(command.type).toBe('StartJamSession');
    });

    it('should handle empty values', () => {
      const command = new StartJamSessionCommand('', '');
  ...
  describe('immutability', () => {
    it('should have readonly properties', () => {
      const command = new StartJamSessionCommand('session-123', 'peer-456');
